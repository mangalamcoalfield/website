  ...
  return (
    <section className="relative w-full overflow-hidden bg-background py-24 text-foreground">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden" aria-hidden="true">
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse 55% 90% at 15% 0%, rgba(21,48,31,.7), transparent 65%), radial-gradient(ellipse 40% 80% at 90% 10%, rgba(174,207,62,.12), transparent 70%)' }} />
